  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {//Define an async function to fetch all users
      ...
      // Send a GET request to the server to fetch users
         const response = await fetch(`${config.API_BASE_URL}/users/findUsers`
          /*'http://localhost:3001/users/findUsers'*/, {
  ...
  useEffect(() => {
    ...
    const fetchScores = async () => {
      try {
        ...
        const response = await fetch (`${config.API_BASE_URL}/scores/findScores`
          /*'http://localhost:3001/scores/findScores'*/, {
          method: 'GET',//HTTP request method
          mode: 'cors',//Enable Cross-Origin Resource Sharing 
          headers: {
...
// Function to fetch quizzes
  const fetchQuizzes = useCallback(async () => {
    try {  
      ...
      const response = await fetch(`${config.API_BASE_URL}/quiz/findQuizzes`
        /*'http://localhost:3001/quiz/findQuizzes'*/, {
        method: 'GET',//HTTP request method
        mode: 'cors',// Enable Cross-Origin Resource Sharing
        headers: {
...
const fetchUserScores = useCallback(async () => {
  try {
    ...
    const response = await fetch(`${config.API_BASE_URL}/scores/findScores/${username}`
      /*`http://localhost:3001/scores/findScores/${username}`*/, {
      method: 'GET',//HTTP request method
      mode: 'cors',//Enable Cross-Origin Resource Sharing 
      headers: {
        'Content-Type': 'application/json', //Specify the Content-Type in the payload as JSON
