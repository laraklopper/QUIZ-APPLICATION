...
//CSS stylesheets
import '../CSS/addQuiz.css'// Import addQuiz css stylesheet
// Bootstrap
  ...
  return (
    <div id='addNewQuiz'>
      ...
      <div id='newQuizForm'>
        ...
        <Row>
          <Col>
            <h3 className='h3' id='addQuesHeading'>ADD QUESTIONS</h3>
          </Col>
        </Row>
          <Row className='quizFormRow'>
          ...
          <Row className='quizFormRow'>
            ...
            <Col xs={6} md={4} id='addQuestionBtnCol'>
              ...
              <Button
                ...
                variant='primary'
                onClick={handleAddQuestion}//Call the handleAddQuestion Function
                id='addQuestionBtn'
              >
                ADD QUESTION
              </Button>
